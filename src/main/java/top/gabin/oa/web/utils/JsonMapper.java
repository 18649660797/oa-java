...
public class JsonMapper {
    ...
    public JsonMapper(Include include, String formatPattern) {
        mapper = new ObjectMapper();
        // 设置输出时包含属性的风格
        if (include != null) {
            mapper.setSerializationInclusion(include);
    ...
    public static JsonMapper nonEmptyMapper(String formatPattern) {
        return new JsonMapper(Include.NON_EMPTY, formatPattern);
    }
    ...
    public static JsonMapper nonDefaultMapper(String formatPattern) {
        return new JsonMapper(Include.NON_DEFAULT, formatPattern);
    }
