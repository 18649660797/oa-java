 ...
 * Created with MailUtil.
 */
package top.gabin.oa.web.utils.mail;
...
public class MailUtil {
    ...
    private static VelocityEngine velocityEngine;			//模板解析
     ...
     */
    public static boolean send(MailBean mailBean) throws MessagingException {
        ...
        MailUtil.sendMail(msg, mailBean);

        return true;
    }

    public static void sendMail(MimeMessage msg, MailBean mailBean){
     ...
     */
    public static MimeMessage createMimeMessage(MailBean mailBean) throws MessagingException {
     ...
     * @return
     */
    public static String getMessage(MailBean mailBean) {
     ...
     * check 邮件
     */
    public static  boolean checkMailBean(MailBean mailBean){
        if (mailBean == null) {
